...
namespace Backend.Migrations
{
    ...
    [Migration("20240228214905_CompanyTable")]
            ...
            modelBuilder.Entity("Backend.Models.LogItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Closed = false,
                            CreatedOn = new DateTime(2024, 2, 28, 21, 49, 5, 233, DateTimeKind.Utc).AddTicks(1818),
            ...
            modelBuilder.Entity("Backend.Models.Vehicle", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2024, 2, 28, 21, 49, 5, 233, DateTimeKind.Utc).AddTicks(1676),
                            Make = "Ford",
                            Mileage = 61000,
                            Model = "F-150",
                            UserId = "66b55995-d23f-4b07-ab16-6425b63c603d",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1728592a-ef4f-4266-8056-b1c49588a5a5",
                            Name = "Administrator",
                            NormalizedName = "ADMINISTRATOR"
                        },
                        new
                        {
                            Id = "cb25849a-4d1f-40be-b553-40e4dbd006ab",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "c35e2824-8c06-4d9e-8746-7f5f3f2b7701",
                            Name = "CompanyUser",
                            NormalizedName = "COMPANYUSER"
                        },
                        new
                        {
                            Id = "41d048ba-8d9c-4873-9a70-cf21a20a19dc",
                            Name = "CompanyAdmin",
